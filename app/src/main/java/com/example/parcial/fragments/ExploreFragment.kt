...
class ExploreFragment : Fragment(), OnViewItemClickedListener<Destination> {
    ...
    private fun loadDestinations(){
        destinations.add(Destination("Baros", "Maldives", 1299, "Spend 5 days and 4 nights in one of the best islands in the world! Bask in the sun while walking in the white sand beach and enjoy the night partying at the popular seaside bars.","1D2N", mutableListOf("https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0d/56/71/a6/baros-aerial-view.jpg?w=1200&h=-1&s=1")))
        ...
        destinations.add(Destination("Buenos Aires", "Argentina", 1234, "Curabitur venenatis nunc dui, nec consequat turpis suscipit sit amet. Ut ac pharetra velit. Quisque laoreet orci turpis, sed malesuada felis facilisis non. Nunc metus nunc, tincidunt ac tincidunt eu, ullamcorper at ligula. Maecenas et dignissim lacus. Vivamus a risus faucibus, interdum nulla sed, commodo ligula. Vivamus nisi urna, viverra quis placerat ut, efficitur id lacus.","3D4N", mutableListOf("https://images.pexels.com/photos/20897698/pexels-photo-20897698/free-photo-of-ciudad-punto-de-referencia-noche-rascacielos.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500")))
    }
    ...
    override fun onViewItemDetail(destination: Destination) {
        val intent = Intent(context, DestinationDetailActivity::class.java).apply {
            ...
            putExtra("images", destination.images.toTypedArray())
        }
